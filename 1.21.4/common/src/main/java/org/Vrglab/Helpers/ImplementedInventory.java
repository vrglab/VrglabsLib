 ...
 * Use {@link Inventories#writeNbt(net.minecraft.nbt.NbtCompound, DefaultedList)} and {@link Inventories#readNbt(net.minecraft.nbt.NbtCompound, DefaultedList)}
...
public interface ImplementedInventory extends SidedInventory {
     ...
     *
     * <p>The default implementation uses {@link Inventories#removeStack(java.util.List, int)}
     *
     * @param slot the slot
