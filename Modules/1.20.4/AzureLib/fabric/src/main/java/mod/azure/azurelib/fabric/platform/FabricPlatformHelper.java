...
import org.Vrglab.AzureLib.fabric.VlAzureLibModFabric;
...
public class FabricPlatformHelper implements IPlatformHelper {
    ...
    public TickingLightBlock getTickingLightBlock() {
        return VlAzureLibModFabric.TICKING_LIGHT_BLOCK;
    }

    @Override
    public BlockEntityType<TickingLightEntity> getTickingLightEntity() {
        return VlAzureLibModFabric.TICKING_LIGHT_ENTITY;
    }

    @Override
    public Enchantment getIncendairyenchament() {
        return VlAzureLibModFabric.INCENDIARYENCHANTMENT;
    }
