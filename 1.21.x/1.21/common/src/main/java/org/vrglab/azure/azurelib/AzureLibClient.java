...
import org.vrglab.azure.azurelib.common.config.client.screen.ConfigGroupScreen;
...
public final class AzureLibClient {
     ...
     */
    @Nullable public static Screen getConfigScreen(Class<?> configClass, Screen previous) {
     ...
     */
    @Nullable public static Screen getConfigScreen(String configId, Screen previous) {
