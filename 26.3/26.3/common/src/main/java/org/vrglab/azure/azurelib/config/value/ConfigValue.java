 ...
 */
package org.vrglab.azure.azurelib.config.value;
...
import org.vrglab.azure.azurelib.config.ConfigUtils;
import org.vrglab.azure.azurelib.config.Configurable;
import org.vrglab.azure.azurelib.config.adapter.TypeAdapter;
import org.vrglab.azure.azurelib.config.client.IValidationHandler;
import org.vrglab.azure.azurelib.config.exception.ConfigValueMissingException;
...
public abstract class ConfigValue<T> implements Supplier<T> {
    ...
    private Configurable.Side side = Configurable.Side.COMMON;
    ...
    public final Configurable.Side getSide() {
        return side;
    }
    ...
    public final void processFieldData(Field field) {
        ...
        this.side = configurable != null ? configurable.side() : Configurable.Side.COMMON;
        this.synchronizeToClient = side == Configurable.Side.COMMON
            && field.getAnnotation(Configurable.Synchronized.class) != null;
