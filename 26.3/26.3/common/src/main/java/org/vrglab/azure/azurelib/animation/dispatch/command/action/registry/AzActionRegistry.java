package org.vrglab.azure.azurelib.animation.dispatch.command.action.registry;
...
import org.vrglab.azure.azurelib.animation.dispatch.command.action.impl.controller.*;
import org.vrglab.azure.azurelib.animation.dispatch.command.action.impl.root.*;
...
public class AzActionRegistry {
    ...
    public static @Nullable <A, T extends StreamCodec<FriendlyByteBuf, A>> T getCodecOrNull(
        ...
        var id = RESOURCE_LOCATION_TO_ID.get(Identifier);
    ...
    public static @Nullable Short getIdOrNull(Identifier Identifier) {
        return RESOURCE_LOCATION_TO_ID.get(Identifier);
    }
    ...
    private static <A extends AzAction> void register(
        ...
        var id = RESOURCE_LOCATION_TO_ID.computeIfAbsent(Identifier, $ -> NEXT_FREE_ID++);
