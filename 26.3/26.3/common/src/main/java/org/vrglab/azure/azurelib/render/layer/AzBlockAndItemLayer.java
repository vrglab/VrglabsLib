package org.vrglab.azure.azurelib.render.layer;
 ...
 * {@link org.vrglab.azure.azurelib.render.AzBufferSource#defer} until the surrounding pipeline's own {@code AzBufferSource} is
 * replayed.
 * <p>
 * {@link BlockState} bones are rendered by wrapping the block in an {@link ItemStack} and
