package org.vrglab.azure.azurelib.animation.dispatch.command.action.codec;
...
import org.vrglab.azure.azurelib.animation.dispatch.command.action.registry.AzActionRegistry;
...
public class AzActionCodec implements StreamCodec<FriendlyByteBuf, AzAction> {
    ...
    public void encode(@NotNull FriendlyByteBuf byteBuf, @NotNull AzAction action) {
        ...
        var id = AzActionRegistry.getIdOrNull(Identifier);
        var codec = AzActionRegistry
            .<AzAction, StreamCodec<FriendlyByteBuf, AzAction>>getCodecOrNull(Identifier);
