package org.vrglab.azure.azurelib.animation.cache;
...
public class AzBakedAnimationCache extends AzResourceCache {
    ...
    public @Nullable AzBakedAnimations getNullable(Identifier Identifier) {
        return bakedAnimations.get(Identifier);
    }
}
